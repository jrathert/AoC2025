// day 01 solution
// "Secret Entrance"
// I also call this "Uhrenmathematik" (clock mathematics)"
// just a simple simulation of movements on a circular track of 100 positions
// part 1 is solved by looking if we end up at position 0
// part 2 is solved by counting how often we pass position 0

import { inputFileName, readFileAsStringArray } from "../aoc/input";


// part 1: move and check end position
...
// part 2: move and count how often we pass 0
...
console.log('Part 1 - End position:', pos1, '/ Zero count:', zeroCount1);

// part 2
const [pos2, zeroCount2] = processMoves(data, false);
console.log('Part 2 - End position:', pos2, '/ Zero count:', zeroCount2);
